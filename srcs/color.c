...
/*   Updated: 2017/12/09 18:51:40 by clegirar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (strct->choix->col->color_uni && strct->choix->col->color_uni_reset == 0)
		strct->hsv->hue += 1;
	if (strct->choix->col->color_uni_alt && strct->choix->col->color_uni_reset == 0)
		strct->hsv->hue_alt += 1;
